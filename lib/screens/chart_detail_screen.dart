            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text('적용 종목:', style: TextStyle(fontWeight: FontWeight.bold)),
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (result != null && result is String) {
                          ...
                          if (updatedData['appliedStockList'] == null || updatedData['appliedStockList'] is! List) {
                ...
                Text('기간: $periodValue $periodUnit', style: const TextStyle(fontSize: 16)),
                const SizedBox(height: 8),
                Text('오차 범위: ${tolerance.toStringAsFixed(1)}%', style: const TextStyle(fontSize: 16)),
                const SizedBox(height: 16),
                if (backtest != null) ...[
                  const Divider(),
                  const Text('백테스트 결과', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
